		...
		<div id="main-content">
			...
			<div class="content-box">
				...
				<div class="content-box-header">
					<h3>Content box</h3>
					<a href="<%=request.getContextPath()%>/admin/user/new" class="button"
				...
				<div class="tab-content">
					...
					<s:form action="delete" id="form1">
						<table>
							...
							<tbody>
								<s:iterator value="userList" begin="startIndex"
									...
									<tr>
										...
										<td>
											<!-- Icons --> <a
											href="<%=request.getContextPath()%>/admin/user/edit?id=${id}"
											title="Edit"><img
												src="../resources/images/icons/pencil.png" alt="Edit" /></a> <a
											href="<%=request.getContextPath()%>/admin/user/delete?id=${id}"
											title="Delete"><img
