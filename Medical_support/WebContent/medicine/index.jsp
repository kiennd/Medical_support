	...
	<div id="body-wrapper">
		...
		<div id="main-content">
			...
			%>
					...
					<a href="<%=request.getContextPath()%>/medicine/new" class="button"
			...
			%>
										...
										<td>
											<!-- Icons --> <a
											href="<%=request.getContextPath()%>/medicine/edit?id=${id}"
											title="Edit"><img
												src="../resources/images/icons/pencil.png" alt="Edit" /></a> <a
											href="<%=request.getContextPath()%>/medicine/delete?id=${id}"
											title="Delete"><img
