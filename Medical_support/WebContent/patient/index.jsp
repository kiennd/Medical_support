		...
		<div id="main-content">
			...
			<div class="content-box">
				...
				<div class="content-box-header">
					...
					<a href="<%=request.getContextPath()%>/patient/new"
							...
							<tbody>
								<s:iterator value="patients" begin="startIndex" end="endIndex"
									...
									<tr>
										...
										<td>
											<!-- Icons --> <a
											href="<%=request.getContextPath()%>/patient/edit?id=${id}"
											title="Edit"><img
												src="../resources/images/icons/pencil.png" alt="Edit" /></a> <a
											href="<%=request.getContextPath()%>/patient/delete?id=${id}"
											title="Delete"><img
												src="../resources/images/icons/cross.png" alt="Delete" /></a> <a
											href="<%=request.getContextPath()%>/laborator/newLaboratorForm?patientid=${id}"
