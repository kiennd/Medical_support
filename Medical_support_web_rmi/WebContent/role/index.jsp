		...
		<div id="main-content">
			...
			<div class="content-box">
				...
				<div class="content-box-header">
					<h3>Role box</h3>
					<a href="<%=request.getContextPath()%>/role/new" class="button"
							...
							<tbody>
								<s:iterator value="roles" begin="%{startIndex}"
									...
									<tr>
										...
										<td>
											<!-- Icons --> <a
											href="<%=request.getContextPath()%>/role/edit?id=<s:property value="id" />"
											title="Edit"><img
												src="../resources/images/icons/pencil.png" alt="Edit" /></a> <a
											href="<%=request.getContextPath()%>/role/delete?id=<s:property value="id" />"
											title="Delete"><img
